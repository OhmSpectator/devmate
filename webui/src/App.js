        ...
        <Table style={{tableLayout: "fixed"}}>
          ...
          <TableBody>
            {devices.map((device) => {
              ...
              const handleTextFieldChange = (event, deviceName) => {
                setDeviceUsernames({
                  ...deviceUsernames,
              ...
              <TableRow key={device.name}>
                ...
                <TableCell>
                    {device.status === 'free' ? (
                        <TextField label="Username" onChange={(event) => handleTextFieldChange(event, device.name)}/>
                    ) : (
                        device.user
                    )}
                </TableCell>
                <TableCell>
                  {device.status === 'free' ? (
                      ...
                      device.status === 'reserved' && (
                          <Button variant="contained" onClick={() => handleAction('release', device.name)}>
                            Release
                          </Button>
                      )
                  )}
              ...
              <TableCell>
                <Button variant="contained" color="secondary" onClick={() => handleDelete(device.name)}>
                  Delete
                </Button>
              </TableCell>
              </TableRow>
